...
bool listaNomes(const std::wstring& usuario, const std::wstring& senha) {
    std::vector<std::wstring> usuarios = {L"Pedro", L"Soneca", L"Julia", L"Rodrigo"};
    std::vector<std::wstring> senhas = {L"Pedrinho", L"Sonequinha", L"Julinha", L"Rodriguinho"};
        ...
        case WM_COMMAND: {
            if (HIWORD(wParam) == BN_CLICKED) {
                ...
                if (controlId == 1) {
                    ...
                    if (listaNomes(usernameStr, password) == 1) {
